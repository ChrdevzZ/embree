...
SET(SYCL_STANDALONE_CLANGCL FALSE)
IF (WIN32 AND CMAKE_CXX_COMPILER MATCHES "(^|[/\\])clang-cl(\\.exe)?$" AND CMAKE_CXX_COMPILER_FRONTEND_VARIANT MATCHES "MSVC")
  SET(SYCL_STANDALONE_CLANGCL TRUE)
ENDIF()
...
IF ((SYCL_ONEAPI_ICX OR SYCL_STANDALONE_CLANGCL) AND WIN32)
...
IF (WIN32)
  ...
  IF (NOT EMBREE_SYCL_SUPPORT)
    ...
    ELSEIF (SYCL_STANDALONE_CLANGCL)
      IF (${MSVC_VERSION} VERSION_GREATER_EQUAL 1916)
